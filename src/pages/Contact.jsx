        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-white shadow-md rounded-lg">
              ...
              <p className="text-gray-600">+92-310-505-9461</p>
            </div>
            ...
            <div className="text-center p-6 bg-white shadow-md rounded-lg">
              ...
              <p className="text-gray-600">contact@furniturehub.com</p>
            </div>
            ...
            <div className="text-center p-6 bg-white shadow-md rounded-lg">
              ...
              <p className="text-gray-600">123 Furniture Street, City, Country</p>
            </div>
          </div>
        </div>
      </div>
